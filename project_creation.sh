...
gcloud beta compute --project=$projectId instance-templates create $instaneTemplate --machine-type=f1-micro --network-tier=PREMIUM --metadata=^,@^lab-logs-bucket=gs://$bucketName,@startup-script=$dir --maintenance-policy=MIGRATE --service-account=738364898483-compute@developer.gserviceaccount.com --scopes=https://www.googleapis.com/auth/servicecontrol,https://www.googleapis.com/auth/service.management.readonly,https://www.googleapis.com/auth/logging.write,https://www.googleapis.com/auth/monitoring.write,https://www.googleapis.com/auth/trace.append,https://www.googleapis.com/auth/devstorage.write_only --region=us-west1 --tags=open-ssh-tag --image=debian-9-stretch-v20191210 --image-project=debian-cloud --boot-disk-size=10GB --boot-disk-type=pd-standard --boot-disk-device-name=$instaneTemplate --reservation-affinity=any
